  ...
  <aside class="Hui-aside" style="">
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-user">
        ...
        <dd>
          <ul>
            <li><a _href="/dsqimo/userlist" href="javascript:;">用户管理</a></li>
          </ul>
        </dd>
      </dl>
      ...
      <dl id="menu-product">
        ...
        <dd>
          <ul>
            <li><a _href="/dsqimo/articleClass" href="javascript:void(0)">分类管理</a></li>
            <li><a _href="/dsqimo/backProductShow" href="javascript:void(0)">产品管理</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-order">
        ...
        <dd>
          <ul>
            <li><a _href="/dsqimo/orderlist" href="javascript:void(0)">订单列表</a></li>
          </ul>
        </dd>
      </dl>
      
      
      <%--只有超级管理员才可以查看管理员管理的页面 --%>
      <c:if test="${backUser.state==1 }">
      <dl id="menu-admin">
        <dt><i class="icon-key"></i> 管理员管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="/dsqimo/adminlist" href="javascript:void(0)">角色管理</a></li>
          </ul>
        </dd>
      </dl>
      </c:if>
