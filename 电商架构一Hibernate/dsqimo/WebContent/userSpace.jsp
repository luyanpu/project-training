...
<body>
		...
		<div class="wrap">
			...
			<div class="cssmenu">
				<ul>
					...
					<li><a href="/dsqimo/checkOut">CheckOut</a></li>
				</ul>
			</div>
					...
					<li><a class="active-icon c2" href="#"> </a>
						<ul class="sub-icon2 list">
							...
							<li><p>Lorem ipsum dolor sit amet, consectetuer</p>
								<p>
									<a href="/dsqimo/check">My order</a> <a
	...
	<div class="login">
		...
		<form action="/dsqimo/upload" enctype="multipart/form-data"
			method="post">
			<div>
				<table  cellpadding="0" cellspacing="1"
					style="text-align: center; margin: 0 auto;border:1;">
					
					<tr >
						<td colspan="2">
							<div>
								<img src="/dsqimo/upload/${user.name }.jpg" onerror="errorImg(this)">
							</div>
						</td>
					</tr>
					
					<tr>
						<td><input name="submitFile" id="submitFile" type="file"
							style="display: none;"
							onchange="$('#fileShowName').val($(this).val());" /> <input
							type="button" id="fileButton" name="fileButton" value="浏览"
							onclick="$('#submitFile').click();" /> <input type="text"
							name="fileShowName" id="fileShowName" readonly="readonly" /></td>
						<td>
							<button type="submit" value="${user.id }" name="${user.id }">上传图片</button>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><a href="/dsqimo/checkOut">查看订单</a></td>
						<td><a href="/dsqimo/indexshow">返回首页</a></td>
					</tr>
				</table>
		...
		<script type="text/javascript">
			function errorImg(img) {
				img.src = "/dsqimo/upload/defult.jpg";
				img.onerror = null;
			}
		</script>
	</div>
