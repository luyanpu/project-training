...
<body>
	<div class="header-top">
		<div class="wrap">
			<div class="logo">
				<a href="index.html"><img src="images/logo.png" alt="商城静态网页模板" /></a>
			</div>
			<div class="cssmenu">
				<ul>
					<li><a href="shop.html">Store Locator</a></li>
					<li><a href="login.html">My Account</a></li>
					<li><a href="/dsqimo/checkout.jsp">CheckOut</a></li>
				</ul>
			</div>
			<!-- 这里加入判断如果登录了显示以下信息 -->
			<c:if test="${user==null}">
	...
	<div class="main">
		<div class="wrap">
			...
			<form action="/dsqimo/search" method="post">
				<select name="id">
					<c:forEach items="${pty }" var="p">
			...
			<div class="content-bottom">
				<div class="box1" style="height: 320px;">
					<c:forEach items="${prolist }" var="p" begin="0" end="2" step="1" varStatus="i">
						...
						<div class="col_1_of_3 span_1_of_3">
							<a href="single.html">
								<div class="view view-fifth">
									<div class="top_box">
										<h3 class="m_1">
											<span style="color: red;">小编推荐商品</span>
										</h3>
										<p class="m_2">${p.name }</p>
										<div class="grid_img">
											<div class="css3">
												<img src="images/pic${i.count}.jpg" alt="" />
											</div>
											<div class="mask">
									...
									<li><img src="images/plus.png" alt="" />
										<ul class="icon1 sub-icon1 profile_img">
											<li><a class="active-icon c1"
												href="/dsqimo/cartAction/add?id=${p.id}">Add To Bag </a>
				...
				<div class="box1" style="height: 320px;">
					<c:forEach items="${prolist }" var="p" begin="3" end="5" step="1" varStatus="i">
							...
							<a href="single.html">
								<div class="view view-fifth">
									<div class="top_box">
										...
										<div class="grid_img">
											<div class="css3">
												<img src="images/pic${i.count+3 }.jpg" alt="" />
											</div>
											<div class="mask">
												<div class="info">Quick View</div>
											</div>
				...
				<table style="width: 500px; margin: 0 auto;">
					<tr>
						...
						<td>
							<%--上一页标签 --%>
							<div class="uppage">
								<a href="/dsqimo/indexshow?pagenumber=${thispage-1}">上一页</a>
							</div> <%--页数选择下拉菜单 --%>
						</td>
						<td>
							<div>
								<form action="/dsqimo/indexshow">
						...
						<td>
							<div>
								<a href="/dsqimo/indexshow?pagenumber=${thispage+1}">下一页</a>
							</div>
						</td>
					</tr>
				</table>
