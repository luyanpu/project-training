...
<div class="pd-20">
  <div class="Huiform">
    <form action="/dsqimo/userRevise" method="post" >
    <input name="id" type="text" style="display:none;" value="${param.id }">
      <table class="table table-bg">
        <tbody>
          ...
          <tr>
            <th></th>
            <td><button class="btn btn-success radius" type="submit" name="status" value="${param.status }"><i class="icon-ok"></i> 确定</button></td>
          </tr>
        </tbody>
      </table>
    </form>
